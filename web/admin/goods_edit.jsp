...
<div class="container-fluid">
	...
	<form class="form-horizontal" action="${pageContext.request.contextPath}/admin/goods_edit" method="post" enctype="multipart/form-data">
		...
		<input type="hidden" name="cover" value="${pageContext.request.contextPath}${g.cover }"/>
		<input type="hidden" name="image1" value="${pageContext.request.contextPath}${g.image1 }"/>
		<input type="hidden" name="image2" value="${pageContext.request.contextPath}${g.image2 }"/>
